...
export const CANDIDATOS_METROPOLITANA: Candidato[] = [
  ...
  { id: 'c_alianza_nacion',   nombre: 'Susel Ana María Paredes Piqué',            partido: 'Alianza Nación',                         color: '#7c3aed', letra: 'AN'  },
  { id: 'c_avancemos',        nombre: 'Francis James Allison Oyague',             partido: 'Avancemos Perú',                         color: '#0891b2', letra: 'AV'  },
  ...
  { id: 'c_contigo',          nombre: 'Luis Alberto Huette Talentino',            partido: 'Partido Contigo',                        color: '#6d28d9', letra: 'CT'  },
  { id: 'c_patriotico',       nombre: 'Sandro Caller Gutiérrez',                  partido: 'Partido Patriótico del Perú',            color: '#1e3a8a', letra: 'PTR' },
  { id: 'c_integracion',      nombre: 'Jessica Viviana Linares Romero',           partido: 'Integración Democrática',                color: '#0f766e', letra: 'ID'  },
  { id: 'c_fuerza_ciudadana', nombre: 'Rubén Daniel Bonilla Espinoza',            partido: 'Fuerza Ciudadana',                       color: '#ea580c', letra: 'FC'  },
  { id: 'c_batuta',           nombre: 'Samir Frank Quispe Caballero',             partido: 'Batuta Perú',                            color: '#0891b2', letra: 'BAT' },
]
...
export const CANDIDATOS_DISTRITALES: Record<string, Candidato[]> = {
  'La Victoria': [
    ...
    { id: 'd04', nombre: 'César Rafael Ibarra Nureña',         partido: 'Partido Popular Cristiano',   color: '#1e40af', letra: 'PPC' },
    ...
    { id: 'd13', nombre: 'Walter Ciro Pérez Noreña',           partido: 'Batuta Perú',                  color: '#0f766e', letra: 'BAT' },
  ...
  // Distritos sin data real cargada aún: solo se muestra el partido (sin nombre inventado)
  default: [
    { id: 'd01', nombre: '', partido: 'Somos Perú',                 color: '#e11d48', letra: 'SP'  },
    { id: 'd02', nombre: '', partido: 'Renovación Popular',         color: '#1d4ed8', letra: 'RP'  },
    { id: 'd03', nombre: '', partido: 'Fuerza Popular',             color: '#f59e0b', letra: 'FP'  },
    { id: 'd04', nombre: '', partido: 'Podemos Perú',               color: '#dc2626', letra: 'PP'  },
    { id: 'd05', nombre: '', partido: 'Acción Popular',             color: '#d97706', letra: 'AP'  },
    { id: 'd06', nombre: '', partido: 'Juntos por el Perú',         color: '#15803d', letra: 'JP'  },
    { id: 'd07', nombre: '', partido: 'Alianza para el Progreso',   color: '#16a34a', letra: 'APP' },
    { id: 'd08', nombre: '', partido: 'Avanza País',                color: '#0891b2', letra: 'AVP' },
  ],
}
