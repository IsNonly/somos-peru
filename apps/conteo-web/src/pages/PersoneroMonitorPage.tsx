    ...
    <div className="space-y-5">
      <div>
        ...
        <p className="text-sm text-slate-500">
          Control de Asistencia y estado de transmisión: Conteo Manual 📝 e Imagen / OCR 🖼️ ·{' '}
        ...
        <div className="px-5 py-3 border-b border-slate-100">
          <div className="flex flex-wrap items-center justify-between gap-2">
            <div>
              ...
              <p className="text-xs text-slate-500">Seguimiento en vivo: Asistencia + Envío Manual 📝 + Envío Imagen 🖼️</p>
            </div>
