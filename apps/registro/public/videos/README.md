...
- El personero debe verlo **completo 1 vez**; no se puede adelantar (se bloquea el seek).
  Al terminar la reproducción se marca `profiles.videos_vistos = 1` y se habilita el paso de la cartilla.
